  									...
  									<div class="tab-content">
  										<div class="tab-content-inner active" data-content="signup">
  											...
  											<form @submit="onSubmit">
  												...
  												<div class="row form-group">
  													<div class="col-md-12">
  														<b-button type="submit" class="btn btn-primary btn-block" style="color: #fff">Sauvegarder</b-button>
  													</div>
  												</div>
...
export default {
  ...
  created () {
    axios.get(`http://localhost:3000/Beer/` + this.$route.params.id)
      .then(response => {
  ...
  methods: {
    onSubmit (evt) {
      evt.preventDefault()
      axios.put(`http://localhost:3000/Beer/` + this.$route.params.id, this.Beer)
        .then(response => {
          this.$router.push({
            name: 'ShowBeer',
